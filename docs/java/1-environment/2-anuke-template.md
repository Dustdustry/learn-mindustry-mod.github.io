...
public class TutorialJavaMod extends Mod {
    ...
    public TutorialJavaMod() {
        Log.info("Loaded TutorialJavaMod constructor.");
    }
    
    @Override
    public void loadContent() {
        Log.info("Loading some java tutorial content.");
    }
}
```
...
class TutorialKotlinMod : Mod() {
    init {
        Log.info("Loaded TutorialKotlinMod constructor.")
    }

    override fun loadContent() {
        Log.info("Loading some kotlin tutorial content.")
    }
}
